...
def main():
    ...
    parser.add_argument(
        ...
        default=False,
        help=(
            "Evaluation-only deployment grid mode. When enabled, ordinary evaluation "
            "runs only learned-score Gaussian-at-T samplers over the requested CFG, "
            "temperature, and RK4-step grids; it disables the expensive oracle-q_t "
            "initialization comparison and never trains."
        ),
    )
    parser.add_argument(
        "--deployment-cfg-grid",
