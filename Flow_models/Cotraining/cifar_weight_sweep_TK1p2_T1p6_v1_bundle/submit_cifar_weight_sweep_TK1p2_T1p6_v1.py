...
GRID = 'generate_cifar_weight_sweep_TK1p2_T1p6_v1.py'
SLURM = 'cifar_weight_sweep_TK1p2_T1p6_v1_cell_job.slurm'
TARGET = 'csem_split_new_weight_sweep_TK1p2_T1p6_v1.py'
LOG_DIR = 'slurm_logs_cifar_weight_sweep_TK1p2_T1p6_v1'
RECEIPT_DIR = 'submission_receipts_cifar_weight_sweep_TK1p2_T1p6_v1'
N_CELLS = 20
RUNS_PER_JOB = 3
...
def main() -> int:
    ...
    for group_idx, group in enumerate(groups):
        ...
        cmd = [
            ...
            "-J", f"cfw{range_tag}",
            "-o", str(out),
            f"--export=ALL,CSEM_WEIGHT_SWEEP_CELL_IDS={cell_spec}",
            str(base / SLURM),
        ]
        print("\n$ " + " ".join(cmd))
