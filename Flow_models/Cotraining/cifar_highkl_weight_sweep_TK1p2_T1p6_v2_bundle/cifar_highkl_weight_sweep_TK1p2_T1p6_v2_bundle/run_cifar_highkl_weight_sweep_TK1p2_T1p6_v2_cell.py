...
RESULTS_ROOT = 'cifar_highkl_weight_sweep_TK1p2_T1p6_v2_results'
LOG_ROOT = 'cifar_highkl_weight_sweep_TK1p2_T1p6_v2_config_logs'
STATUS_ROOT = 'cifar_highkl_weight_sweep_TK1p2_T1p6_v2_status'
N_CELLS = 20
...
def main() -> int:
    ...
    print("=" * 96)
    print("CIFAR CSEM / TERMINAL-KL HIGH-KL WEIGHT SWEEP")
