...
GRID_NAME = "fmnist_csem_why_grid_v3.py"
SLURM_NAME = "fmnist_csem_why_fix_pair_job_v2.slurm"
TARGET_NAME = "csem_split_metric_why_v3.py"
LOG_DIR_NAME = "slurm_logs_csem_why_v3"
RECEIPT_DIR_NAME = "submission_receipts_csem_why_v3"
...
def main() -> int:
    ...
    for pair_id in pairs:
        out = log_dir / f"csem_why_fix_pair_{pair_id:02d}_%j.out"
        cmd = [
            "sbatch",
            "-J", f"cwhyF{pair_id}",
            "-o", str(out),
