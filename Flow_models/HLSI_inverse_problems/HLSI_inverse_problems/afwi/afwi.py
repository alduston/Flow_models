...
# Mildly less ill-posed acquisition: a few more shots, slightly deeper
# near-surface arrays, and grid-aware placement so receivers do not collapse
# onto duplicate finite-difference nodes on the 32 x 32 mesh.
N_SOURCES = 6
SOURCE_DEPTH = 0.12
RECEIVER_DEPTH = 0.09
SOURCE_WIDTH = 0.020
