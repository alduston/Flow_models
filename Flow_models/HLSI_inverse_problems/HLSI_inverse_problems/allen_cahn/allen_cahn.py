...
for _path in (THIS_DIR, os.getcwd(), REPO_ROOT):
...
# Alternating likelihood-corrected transport experiment.
...
print('\n=== Allen–Cahn iterative transport pipeline complete ===')
