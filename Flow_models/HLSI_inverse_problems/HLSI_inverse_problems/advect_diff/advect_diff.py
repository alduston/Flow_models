...
SAMPLER_CONFIGS = OrderedDict([
    ('MALA (prior)', {'init': 'prior', 'init_steps': 0, 'mala_steps': 500, 'mala_burnin': 100, 'mala_dt': 1e-4, 'is_reference': True}),
    ('MALA_ref_Tweedie', {'init': 'tweedie', 'init_weights': 'None', 'init_steps': 200, 'mala_steps': 0, 'mala_burnin': 0, 'log_mean_ess': True, 'mala_refs': True}),
    ('MALA_ref_Blend', {'init': 'blend', 'init_weights': 'None', 'init_steps': 200, 'mala_steps': 0, 'mala_burnin': 0, 'log_mean_ess': False, 'mala_refs': True}),
    ('MALA_ref_HLSI', {'init': 'HLSI', 'init_weights': 'None', 'transition_w': 'ou', 'init_steps': 200, 'mala_steps': 0, 'mala_burnin': 0, 'log_mean_ess': True, 'mala_refs': True}),
    ('MALA_ref_CE-HLSI', {'init': 'CE-HLSI', 'init_weights': 'None', 'transition_w': 'ou', 'init_steps': 200, 'mala_steps': 0, 'mala_burnin': 0, 'log_mean_ess': True, 'mala_refs': True}),
