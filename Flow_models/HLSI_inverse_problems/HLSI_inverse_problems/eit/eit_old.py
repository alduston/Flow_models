...
Original file is located at
    https://colab.research.google.com/drive/1ldKvcRIwmhOsijgidtO7tnIBJljS4YIJ
"""
...
RUN_RESULTS_DIR = os.path.join(RUN_RESULTS_ROOT, f'eit_hlsi_{RUN_TIMESTAMP}')
os.makedirs(RUN_RESULTS_DIR, exist_ok=True)
RUN_RESULTS_STEM = f'eit_hlsi_{RUN_TIMESTAMP}'
...
def save_reproducibility_log(extra_sections=None):
    ...
    lines = []
    lines.append('EIT HLSI run reproducibility log')
    lines.append('=' * 72)
    ...
    excluded_names = {
        ...
        'samples_eit', 'ess_logs_eit', 'mean_fields', 'method_voltage_preds',
    ...
    for name, value in globals().items():
        ...
        if name.isupper() or name in {
            ...
            'obs_locations', 'd_lat', 'N_CURRENT_PATTERNS', 'N_ELECTRODES'
        }:
...
repro_log_path = save_reproducibility_log(
    extra_sections={
        ...
        'summary_stats': {
            ...
            'num_methods_with_samples': len(samples_eit),
            'num_methods_with_mean_fields': len(mean_fields),
            'num_methods_with_ess_logs': len(ess_logs_eit),
        },
    }
)
