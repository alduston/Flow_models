...
def evaluate_current_state(
    ...
    if unet is not None:
         configs.extend([
            ...
            {"method": "rk4_ode",  "steps": 25, "desc": "RandToken (RK4)", "use_rand_token": True,"time_schedule": "log_t",
                 "init_mode": "prior", "t_max": 3.0, "t_min": 1e-3, "cfg_level": 3.0, "readout_mode": "direct"},
            #{"method": "rk4_ode",  "steps": 25, "desc": "RandToken (RK4)", "use_rand_token": True,"time_schedule": "linear",
                 #"init_mode": "oracle", "t_max": 2.0, "t_min": 1e-3, "cfg_level": 3.0, "readout_mode": "direct"},
    ...
    configs.extend([
        {"method": "rk4_ode", "steps": 25, "desc": "Oracle (RK4)", "use_rand_token": True, "cfg_level": 3,
             "init_mode": "prior", "t_max": 3.0, "t_min": 1e-3, "use_oracle": True, "time_schedule": "log_t"},
...
def parse_metric_column(col_name):
    ...
    # HandleCSEM Co-trained Diffusion Models mse_gap_eps / mse_gap_score specially (3-token metric name)
